...
const links = [
  { label: 'GitHub', sub: '@lazyekansh', href: USER.github, Icon: GithubIcon, color: 'hover:text-white hover:border-zinc-500' },
...
const socialPlatforms = [
  {
    label: 'Pinterest',
    href: 'https://pinterest.com/lazyekansh',
    icon: (
  ...
  {
    label: 'Discord',
    href: 'https://discord.com/users/lazyekansh',
    icon: (
  ...
  {
    label: 'Reddit',
    href: 'https://reddit.com/user/lazyekansh',
    icon: (
